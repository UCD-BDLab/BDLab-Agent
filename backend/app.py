...
index, raw_chunks, chunk_metadata, file_titles, embedder = read_files(files_path)
model, tokenizer = load_llm("/home/vicente/Github/BDLab-Agent/backend/data/GPTModels/gpt-oss-20b")
